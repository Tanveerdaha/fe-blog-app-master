        ...
        <>
            <div className={`my-10 border-2 w-80 md:w-auto rounded-tl-3xl rounded-br-3xl px-5 py-2 md:py-5 flex md:flex-row flex-col items-center md:gap-5 gap-10 justify-center ${theme === 'dark' ? 'shadow-2xl border-gray-600' : 'border-gray-300 shadow-xl'} `}>
                <div className="flex  flex-col gap-5 justify-start">
                    ...
                    <div className="">
                        <a
                            href="https://github.com/Tanveerdaha?tab=repositories"
                            target="_blank"
                            rel="noopener noreferrer"
                            className='font-semibold py-1 bg-violet-500 w-full rounded-md flex items-center gap-2 text-center justify-center hover:bg-violet-700 transition-all'
                        >
                            <FaGithub size={25} />
