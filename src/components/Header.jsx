            ...
            <nav className={`z-20 sticky top-0 border-b shadow-sm md:px-10 px-2 py-2 ${theme === 'dark' ? 'bg-zinc-800 border-gray-700' : 'bg-blue-100 border-gray-300'} `}>
                ...
                <div className='md:flex hidden justify-between z-20'>
                    ...
                    <NavLink className=" flex items-center cursor-pointer" to={'/'}>
                        <motion.h1 className='text-lg font-bold' title='Draft code'
                            initial={{ y1: 1000 }}
                            animate={{ y: [-20, 0] }}
                            transition={{
                                duration: 1,
                        ...
                        >Draft</motion.h1>
                        <motion.h1 className='text-xl font-bold px-2  text-white rounded-md bg-gradient-to-r from-blue-400 via-blue-500 to-blue-000 ' title='Draft code'
                        >code</motion.h1>
                    </NavLink>
